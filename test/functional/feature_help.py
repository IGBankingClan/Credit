...
"""Verify that starting credit with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start credit with -h for help text")
        ...
        self.log.info("Start credit with -version for version information")
