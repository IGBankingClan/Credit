...
* credit.conf: contains configuration settings for creditd or credit-qt
* creditd.pid: stores the process id of creditd while running
...
* debug.log: contains debug information and general logging generated by creditd or credit-qt
