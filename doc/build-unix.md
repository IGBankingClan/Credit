...
See the section "Disable-wallet mode" to build Credit Core without wallet.
...
As mentioned above, when maintaining portability of the wallet between the standard Credit Core distributions and independently built
